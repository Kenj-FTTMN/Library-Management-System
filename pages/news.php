        ...
        <div class="row g-4">
          ...
          <div class="col-lg-8">
            ...
            <article class="featured-post position-relative mb-4" data-aos="fade-up">
              <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-hero-9.webp" alt="Featured post" class="img-fluid">
            ...
            <div class="row g-4">
              <div class="col-md-6">
                <article class="secondary-post" data-aos="fade-up">
                  <div class="post-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-1.webp" alt="Post" class="img-fluid">
                  </div>
                  <div class="post-content">
                    <div class="post-meta">
                      <span class="category">Politics</span>
              ...
              <div class="col-md-6">
                <article class="secondary-post" data-aos="fade-up" data-aos-delay="100">
                  <div class="post-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-2.webp" alt="Post" class="img-fluid">
                  </div>
                  <div class="post-content">
                    <div class="post-meta">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="top-stories">
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-1.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-2.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-3.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                          <span class="category">Politics</span>
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-4.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-5.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                ...
                <div class="tab-pane fade" id="trending">
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-6.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                          <span class="category">Politics</span>
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-7.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-8.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                ...
                <div class="tab-pane fade" id="latest">
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-9.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
                  ...
                  <article class="tab-post">
                    <div class="row g-0 align-items-center">
                      <div class="col-4">
                        <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-square-10.webp" alt="Post" class="img-fluid">
                      </div>
                      <div class="col-8">
                        <div class="post-content">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <article>
              ...
              <div class="post-img">
                <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-1.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="<?php echo ASSETS_PATH; ?>/img/person/person-f-12.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <article>
              ...
              <div class="post-img">
                <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-2.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="<?php echo ASSETS_PATH; ?>/img/person/person-f-13.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <article>
              ...
              <div class="post-img">
                <img src="<?php echo ASSETS_PATH; ?>/img/blog/blog-post-3.webp" alt="" class="img-fluid">
              </div>
              ...
              <div class="d-flex align-items-center">
                <img src="<?php echo ASSETS_PATH; ?>/img/person/person-m-10.webp" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
