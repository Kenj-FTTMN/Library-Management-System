      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-4" data-aos="fade-left" data-aos-delay="300">
              <div class="hero-visual">
                <div class="image-stack">
                  <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-6.webp" alt="Campus View" class="img-fluid primary-img">
        ...
        <div class="facilities-grid" data-aos="fade-up" data-aos-delay="200">
          <div class="category-card academic" data-aos="zoom-in" data-aos-delay="100">
            ...
            <div class="card-content">
              <div class="facility-image">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-7.webp" alt="Academic Building" class="img-fluid">
              </div>
          ...
          <div class="category-card sports" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div class="card-content">
              <div class="facility-image">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-8.webp" alt="Sports Complex" class="img-fluid">
              </div>
              <div class="facility-list">
                <div class="facility-item">
                  <i class="bi bi-check2-circle"></i>
          ...
          <div class="category-card residence" data-aos="zoom-in" data-aos-delay="300">
            ...
            <div class="card-content">
              <div class="facility-image">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-9.webp" alt="Student Housing" class="img-fluid">
              </div>
              <div class="facility-list">
                <div class="facility-item">
                  <i class="bi bi-check2-circle"></i>
              ...
              <div class="tour-visual">
                <div class="video-container">
                  <video autoplay="" muted="" loop="">
                    <source src="<?php echo ASSETS_PATH; ?>/img/education/video-5.mp4" type="video/mp4">
                  </video>
          ...
          <div class="campus-slider swiper init-swiper">
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="highlight-card">
                  <div class="card-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-10.webp" alt="Central Library" class="img-fluid" loading="lazy">
              ...
              <div class="swiper-slide">
                <div class="highlight-card">
                  <div class="card-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-11.webp" alt="Innovation Hub" class="img-fluid" loading="lazy">
                    <div class="image-overlay">
              ...
              <div class="swiper-slide">
                <div class="highlight-card">
                  <div class="card-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-1.webp" alt="Student Center" class="img-fluid" loading="lazy">
                    <div class="image-overlay">
              ...
              <div class="swiper-slide">
                <div class="highlight-card">
                  <div class="card-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-2.webp" alt="Wellness Center" class="img-fluid" loading="lazy">
                    <div class="image-overlay">
