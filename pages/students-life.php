      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="200">
            <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-1.webp" class="img-fluid rounded" alt="Campus Life">
          </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="athletics-card">
                  <img src="<?php echo ASSETS_PATH; ?>/img/education/activities-2.webp" class="img-fluid" loading="lazy" alt="Swimming">
              ...
              <div class="swiper-slide">
                <div class="athletics-card">
                  <img src="<?php echo ASSETS_PATH; ?>/img/education/activities-4.webp" class="img-fluid" loading="lazy" alt="Basketball">
                  <div class="athletics-content">
                    <h5>Basketball</h5>
              ...
              <div class="swiper-slide">
                <div class="athletics-card">
                  <img src="<?php echo ASSETS_PATH; ?>/img/education/activities-6.webp" class="img-fluid" loading="lazy" alt="Soccer">
                  <div class="athletics-content">
                    <h5>Soccer</h5>
              ...
              <div class="swiper-slide">
                <div class="athletics-card">
                  <img src="<?php echo ASSETS_PATH; ?>/img/education/activities-8.webp" class="img-fluid" loading="lazy" alt="Tennis">
                  <div class="athletics-content">
                    <h5>Tennis</h5>
          ...
          <div class="row g-4">
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div class="facility-card">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-4.webp" class="img-fluid" alt="Housing">
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
              <div class="facility-card">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-5.webp" class="img-fluid" alt="Dining">
                <div class="facility-info">
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
              <div class="facility-card">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-6.webp" class="img-fluid" alt="Library">
                <div class="facility-info">
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
              <div class="facility-card">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-7.webp" class="img-fluid" alt="Recreation">
                <div class="facility-info">
        ...
        <div class="student-gallery mt-5 pt-3" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="row g-3">
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="100">
              <a href="<?php echo ASSETS_PATH; ?>/img/education/students-1.webp" class="gallery-item glightbox">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/students-1.webp" class="img-fluid" loading="lazy" alt="Student Life">
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="200">
              <a href="<?php echo ASSETS_PATH; ?>/img/education/students-2.webp" class="gallery-item glightbox">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/students-2.webp" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
                  <i class="bi bi-plus-circle"></i>
                </div>
              </a>
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="300">
              <a href="<?php echo ASSETS_PATH; ?>/img/education/students-3.webp" class="gallery-item glightbox">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/students-3.webp" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
                  <i class="bi bi-plus-circle"></i>
                </div>
              </a>
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="400">
              <a href="<?php echo ASSETS_PATH; ?>/img/education/students-4.webp" class="gallery-item glightbox">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/students-4.webp" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
                  <i class="bi bi-plus-circle"></i>
                </div>
              </a>
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="500">
              <a href="<?php echo ASSETS_PATH; ?>/img/education/students-5.webp" class="gallery-item glightbox">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/students-5.webp" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
                  <i class="bi bi-plus-circle"></i>
                </div>
              </a>
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="600">
              <a href="<?php echo ASSETS_PATH; ?>/img/education/students-6.webp" class="gallery-item glightbox">
                <img src="<?php echo ASSETS_PATH; ?>/img/education/students-6.webp" class="img-fluid" loading="lazy" alt="Student Life">
                <div class="gallery-overlay">
                  <i class="bi bi-plus-circle"></i>
                </div>
              </a>
