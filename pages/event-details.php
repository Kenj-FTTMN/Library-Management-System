        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="event-image mb-4" data-aos="fade-up">
              <img src="<?php echo ASSETS_PATH; ?>/img/education/events-9.webp" alt="Event" class="img-fluid rounded">
            </div>
            ...
            <div class="event-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="event-gallery mt-5" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="row g-4 mt-2">
                  <div class="col-md-4">
                    <a href="<?php echo ASSETS_PATH; ?>/img/education/events-1.webp" class="glightbox">
                      <img src="<?php echo ASSETS_PATH; ?>/img/education/events-1.webp" alt="Event Gallery" class="img-fluid rounded">
                    </a>
                  </div>
                  <div class="col-md-4">
                    <a href="<?php echo ASSETS_PATH; ?>/img/education/events-2.webp" class="glightbox">
                      <img src="<?php echo ASSETS_PATH; ?>/img/education/events-2.webp" alt="Event Gallery" class="img-fluid rounded">
                    </a>
                  </div>
                  <div class="col-md-4">
                    <a href="<?php echo ASSETS_PATH; ?>/img/education/events-3.webp" class="glightbox">
                      <img src="<?php echo ASSETS_PATH; ?>/img/education/events-3.webp" alt="Event Gallery" class="img-fluid rounded">
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class="sidebar-widget organizer-info" data-aos="fade-left" data-aos-delay="300">
                ...
                <div class="organizer-details">
                  <div class="organizer-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/person/person-m-5.webp" class="img-fluid rounded" alt="Organizer">
                  </div>
