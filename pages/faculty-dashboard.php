...
<!-- Faculty Dashboard -->
<section id="faculty-dashboard" class="section">
  <div class="container">
    <!-- Welcome Section -->
        ...
        <div class="card border-warning">
          <div class="card-body">
            <h2 class="mb-3">
              ...
              Welcome, <?php echo htmlspecialchars($user_data['first_name'] ?? 'Faculty'); ?>!
            </h2>
            <p class="lead text-muted">Faculty Dashboard - Manage your book borrowings and returns.</p>
      ...
      <div class="col-12">
        <div class="card" data-aos="fade-up">
          ...
          <div class="card-body">
            ...
            <?php else: ?>
              <p class="text-muted text-center">No borrow records found.</p>
            <?php endif; ?>
          </div>
        </div>
      </div>
