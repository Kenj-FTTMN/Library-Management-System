      ...
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6">
          <div class="about-image" data-aos="zoom-in" data-aos-delay="300">
            <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-5.webp" alt="Campus" class="img-fluid rounded">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2 mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="intro-image">
              <img src="<?php echo ASSETS_PATH; ?>/img/education/teacher-5.webp" alt="School Leadership" class="img-fluid rounded-lg">
              ...
              <div class="card-inner">
                <div class="card-front">
                  <div class="member-image">
                    <img src="<?php echo ASSETS_PATH; ?>/img/person/person-m-4.webp" alt="Principal" class="img-fluid">
                  </div>
