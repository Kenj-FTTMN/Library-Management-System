      ...
      <div class="row mb-5">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
          <div class="alumni-image">
            <img src="<?php echo ASSETS_PATH; ?>/img/education/campus-8.webp" alt="Alumni gathering" class="img-fluid rounded">
          </div>
        </div>
      </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div class="alumni-card">
            <div class="alumni-image">
              <img src="<?php echo ASSETS_PATH; ?>/img/person/person-m-4.webp" alt="Alumni" class="img-fluid">
            </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="400">
          <div class="alumni-card">
            <div class="alumni-image">
              <img src="<?php echo ASSETS_PATH; ?>/img/person/person-f-6.webp" alt="Alumni" class="img-fluid">
            </div>
            <div class="alumni-content">
        ...
        <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="500">
          <div class="alumni-card">
            <div class="alumni-image">
              <img src="<?php echo ASSETS_PATH; ?>/img/person/person-m-9.webp" alt="Alumni" class="img-fluid">
            </div>
            <div class="alumni-content">
              <h4>James Wilson</h4>
